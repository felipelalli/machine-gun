...
package br.eti.fml.machinegun.externaltools;
...
public interface PersistedQueueManager {
     ...
     * you are able to use
     * the {@link br.eti.fml.machinegun.auditorship.ArmyAudit} to intercept
     * some error; but it will work fine <u>only if</u> the specific
     * implementation gossips what its does to the
     * {@link br.eti.fml.machinegun.auditorship.ArmyAudit auditor}.
     ...
     * @see br.eti.fml.machinegun.auditorship.ArmyAudit#errorWhenPuttingIntoAnEmbeddedQueue
     */
     ...
     * @see br.eti.fml.machinegun.auditorship.ArmyAudit#errorWhenRegisteringANewConsumerInAnEmbeddedQueue
     */
